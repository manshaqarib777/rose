...
<div class="modal fade" id="liveStreamingForm" tabindex="-1" role="dialog" aria-labelledby="live-stream-modal-form" aria-hidden="true">
                ...
                <div class="card bg-white shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5 position-relative">
                        ...
                        <div class="mb-3">
                            ...
                            <strong>{{ trans('general.create_live_stream') }}</strong>
                        </div>

                        <form method="post" action="{{ url('create/live') }}" id="formSendLive" enctype="multipart/form-data">
                            ...
                            {{-- <div class="data-item">
                                <label for="post_title" class="h5">{{ trans('general.Thumbnail') }}</label>
                                <input type="file" name="livestream_image">
                            </div> --}}

                            <div class="form-group">
                                <input type="file" name="livestream_image" accept="image/*">
                            </div>
                                ...
                                <div class="input-group mb-2" id="AvailabilityGroup">
                                    ...
                                    <select name="availability" id="Availability" class="form-control custom-select">
                                        <option value="all_pay"
                                            data-text="{{ trans('general.desc_available_everyone_paid') }}">
                                            {{ trans('general.available_everyone_paid') }}</option>
                                        <option value="free_paid_subscribers"
                                            data-text="{{ trans('general.info_price_live') }}">
                                            {{ trans('general.available_free_paid_subscribers') }}</option>

                                        @if ($settings->live_streaming_free)
                                            <option value="everyone_free"
                                                data-text="{{ trans('general.desc_everyone_free') }}">
                                                {{ trans('general.available_everyone_free') }}</option>
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="form-group mb-0">
                                <div class="input-group">
                                    ...
                                    <input type="number" min="{{ $settings->live_streaming_minimum_price }}"
                                        autocomplete="off" id="onlyNumber" class="form-control priceLive" name="price"
                                        placeholder="{{ __('general.price') }} ({{ __('general.minimum') }} {{ Helper::priceWithoutFormat($settings->live_streaming_minimum_price) }})">
                                </div>
                            </div><!-- End form-group -->
                            <small class="form-text mb-4"
                                id="descAvailability">{{ trans('general.desc_available_everyone_paid') }}</small>
                            ...
                            <div class="text-center">
                                ...
                                <button type="submit" id="liveBtn" class="btn btn-primary mt-4 liveBtn"><i></i>
