...
<div class="navbar-collapse collapse d-lg-block bg-white" id="navbarUserHome">
    ...
    <div class="py-1 mb-4">
        <div class="text-center">
            @foreach (Categories::where('mode', 'on')->orderBy('name')->get() as $category)
                <a class="d-block btn-sm  e-none btn-category @if (Request::path() == "category/$category->slug" ||
                    ...
                    <img src="{{ url('public/img-category', $category->image) }}" class="mr-2 rounded" width="25" />
