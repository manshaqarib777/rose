...
@auth
    ...
    @endif
    <script src="{{ asset('public/js/send-gift.js') }}?v={{ $settings->version }}{{ str_random() }}"></script>
@endauth
                    ...
                    success: function(result) {
                        ...
                        if (result.success) {
                            ...
                            if (result.check_account) {
                                ...
                                $('#btnLoginRegister').find('i').removeClass(
                            ...
                            if (result.errors) {
                                ...
                                for ($key in result.errors) {
                                    error += '<li><i class="far fa-times-circle"></i> ' + result.errors[
                                        $key] + '</li>';
                                }
