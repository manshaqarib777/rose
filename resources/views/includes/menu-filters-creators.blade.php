    ...
    <div class="navbar-collapse collapse d-lg-block" id="navbarFilters">
        <div class="btn-block bg-white ">
            <span>
                ...
                <a class=" d-block btn-sm e-none btn-category @if (request()->is('creators') || (isset($isCategory) && request()->is('category/' . $slug . ''))) active-category @endif"
                ...
                <a class=" d-block btn-sm  e-none btn-category @if (request()->is('creators/featured') || (isset($isCategory) && request()->is('category/' . $slug . '/featured'))) active-category @endif"
                ...
                <a class=" d-block btn-sm  e-none btn-category @if (request()->is('creators/more-active') ||
                    ...
                    <img src="{{ url('public/img/more-active.png') }}" class="mr-2" width="25" />
                    {{ trans('general.more_active') }}
                </a>

                <a class=" d-block btn-sm  e-none btn-category @if (request()->is('creators/new') || (isset($isCategory) && request()->is('category/' . $slug . '/new'))) active-category @endif"
                ...
                <a class=" d-block btn-sm  e-none btn-category @if (request()->is('creators/free') || (isset($isCategory) && request()->is('category/' . $slug . '/free'))) active-category @endif"
                ...
                @if ($settings->search_creators_genders)
                    <a class=" d-block btn-sm e-none btn-category" href="javascript:;"
                        data-toggle="modal" data-target="#filterGendersAge">
                        <img src="{{ url('public/img/genders.png') }}" class="mr-2" width="25" />
                        {{ trans('general.gender_age') }}
                    </a>
                @endif

                @if ($settings->live_streaming_status == 'on')
                    <a class=" d-block btn-sm e-none btn-category @if (request()->is('explore/creators/live')) active-category @endif"
