      ...
      <div class="offcanvas-body px-0 scrollbar">
          <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start list-sidebar" id="menu">
            ...
            @if (auth()->user()->hasPermission('countries_states'))
              ...
              <li class="nav-item">
                  <a href="{{ url('panel/admin/widgets') }}" class="nav-link text-truncate @if (request()->is('panel/admin/widgets')) active @endif">
                      <i class="bi-list-stars me-2"></i> {{ __('admin.widgets') }}
                  </a>
              </li><!-- /end list -->
              @endif
