...
@section('content')
    <section class="section pb-0 h-100 section-msg position-fixed">
        <div class="container container-full-w " style="height: 85%;">
            <div class="row justify-content-center h-100">
                ...
                <div class="col-md-9 h-100 p-0 first">
                    ...
                    <div class="card w-100 rounded-0 border-top-0 h-100">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    @if ($user->active_status_online == 'yes')
                                        ...
                                        @if ($user->hide_last_seen == 'no')
                                            ...
                                            <span id="timeAgo">
                                                <small class="timeAgo @if (Helper::isOnline($user->id)) display-none @endif"
                                                    id="lastSeen"
                                ...
                                @if (
                                    ...
                                    <a href="javascript:void(0);"
                                        class="f-size-20 text-muted float-right mr-3 text-decoration-none @if (Helper::isOnline($user->id)) requestLivePrivateModal @else buttonDisabled @endif"
                                        @if (Helper::isOnline($user->id)) data-toggle="tooltip" data-placement="bottom" title="{{ __('general.request_private_live_stream') }}" @endif
                                        role="button">
                                        <i class="feather icon-video"></i>
                                    </a>
                                @endif

                                <a href="javascript:void(0);" class="f-size-20 text-muted float-right" id="dropdown_options"
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown_options">
                                    ...
                                    @if ($messages->count() != 0)
                                        ...
                                        {!! Form::button('<i class="feather icon-trash-2 mr-2"></i> ' . __('general.delete'), [
                                            'class' => 'dropdown-item actionDelete',
                                        ]) !!}
                                        {!! Form::close() !!}
                                ...
                                @if ($subscribedToYourContent || $subscribedToMyContent || auth()->user()->isSuperAdmin() || $user->isSuperAdmin())
                                    ...
                                    <form action="{{ url('message/send') }}" method="post" accept-charset="UTF-8"
                                        ...
                                        <div class="justify-content-between mt-3 align-items-center">
                                            ...
                                            <div
                                                class="d-inline-block w-100-mobile float-right rounded-pill mt-1 position-relative">
