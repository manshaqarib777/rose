...
class LiveStreamingsController extends Controller
{
  ...
  public function create()
  {
    ...
    $fileuploader = $this->request->input('fileuploader-list-livestream_image');
    ...
    if($fileuploader){
      $live->livestream_image   = $fileuploader[0]['file'];
      // $this->moveFileStorage($fileuploader[0]['file'], $path);
    }
    ...
    return redirect()->to(url('live', auth()->user()->username));
