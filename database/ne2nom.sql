...
(1, 'Yo-fans', 'Elevate your brand with strategic marketing. Connect authentically, leverage digital platforms, and captivate your audience for sustainment', 'donations,support,creators,Creaty,subscription', 250, '1', '', 'no-reply@rose-trip.com', 'rosetrip123456@gmail.com', 'off', 307200, '', 'paypal@yo-fans.com', '', '', '', '', '', '$', 'USD', 2, 'PayPal', '400', 20, 100, 'M d, Y', 'https://rose-trip.com/p/privacy', 'https://rose-trip.com/p/terms-of-service', 'left', '', 50, '', '', 150, 15, 'on', 5, 2, '1', '1', 'logo-1701469341.png', 'logo_2-1701469341.png', 'favicon-1701469341.png', 'home_index-1704561371.png', 'background-1703273292.jpg', 'image_index_1-1703272603.png', 'image_index_2-1703272603.png', 'image_index_3-1703272603.png', 'image_index_4-1703272603.png', 'default.jpg', 'off', '#ff0066', 'dot', '5.5', 'https://yousite.com/p/cookies', 500, 'off', 'hyper core LLC', 'United States', '1309 Coffeen Avenue STE 1200 Sheridan', 'Wyoming', '82801', '36-4981849', 'on', 0, 1024, 'on', 'on', 5, 500, 5, 100, 5, 1000, 'rounded', '', 'off', 'on', '#ffffff', '#3a3a3a', '#ffffff', '#5f5f5f', 'off', '', 'on', 'on', '', '', 'off', 'male,female', '', 'all', 'on', 'off', 'off', 'real_money', 5, 5, '', '', '', 3, 'on', 'off', 'off', 'off', 'primary', 'on', 'on', 'on', 5, '1', 'off', 'on', 5, 100, '195404c88e8c424fb229dd3b25b79e6d', '', '', 300, 20, '1', 'custom', 1, 5, 100, 1, 1, 1, 0, '', 1, 0, 0, 0, 0, 0, 1, 1, 0, 1, '', '', '', 1, '43c343d9-0934-4222-a099-aa920048705b', 'MmZiM2QxMTItZTZhNi00ZDA0LTgxYjItMmE4ZWE5MWVmNDQ1', 0, 1, 0, 1, 1, 1, 30, 'off', 'off', '', 'watermak-video.png', 'k-650a7458567fcaa7431ff5040e97387b', 'ffmpeg', 1, '', '', 'on', 5.00, 30.00, 60, 1, 'center', 'Virginia', 'off', 'light', 0, 0, 0, 0, 0, 0);
...
(1, 'yo-live.com', 'Live Cam Shows, FREE Chat with Webcam Girls, Fun', 'https://yo-live.com/', '1701972824-IXtKQfNoHhdeoUCQA7RVGAn8HCFK1MwG.png', 82, 250, 1, '2024-12-07 18:08:33', '2023-12-07 18:08:33', '2024-06-07 03:55:56'),
(2, 'cherish dating app', 'The easiest premium global chat app to make friends and find connections', 'https://play.google.com/store/apps/details?id=bnb.App_kor_cherish_bnb', '1701972814-NGU8PMN71Usvo6F6VEj8apjjXfkfoOG1.png', 82, 248, 1, '2024-12-07 18:08:55', '2023-12-07 18:08:55', '2024-06-07 04:40:55');

-- --------------------------------------------------------

--
-- 테이블 구조 `ad_click_impressions`
--
...
--
-- 테이블의 덤프 데이터 `ad_click_impressions`
--
...
(1, 'normal', 1, NULL, '123', 'live_5p38p_1', 0, 0, '1', NULL, '2023-12-07 18:14:55', '2023-12-07 18:15:01', NULL, 'everyone_free', NULL),
(2, 'normal', 1, NULL, '123', 'live_ldk0m_1', 0, 0, '0', NULL, '2023-12-08 15:11:14', '2023-12-08 15:12:50', NULL, 'everyone_free', NULL);

-- --------------------------------------------------------

--
-- 테이블 구조 `live_streaming_private_requests`
--
...
(37, 1, '121.164.206.28', 'WebKit', 'desktop', 'Chrome 125.0.0.0', 'Windows 10.0', NULL, '2024-06-05 20:59:23', '2024-06-05 20:59:23'),
...
--
-- 테이블의 인덱스 `admin_settings`
--
ALTER TABLE `admin_settings`
  ADD PRIMARY KEY (`id`);

--
-- 테이블의 인덱스 `advertisings`
--
...
--
-- 테이블의 인덱스 `live_streaming_private_requests`
--
...
--
-- 테이블의 인덱스 `media_welcome_messages`
--
...
--
-- 테이블의 인덱스 `payment_gateways`
--
ALTER TABLE `payment_gateways`
  ADD PRIMARY KEY (`id`);

--
-- 테이블의 인덱스 `pay_per_views`
--
...
--
-- 테이블의 인덱스 `referral_transactions`
--
...
--
-- 테이블의 인덱스 `story_fonts`
--
ALTER TABLE `story_fonts`
  ADD PRIMARY KEY (`id`);

--
-- 테이블의 인덱스 `story_views`
--
...
--
-- 테이블의 인덱스 `subscription_deleteds`
--
...
--
-- 테이블의 인덱스 `verification_requests`
--
...
--
-- 테이블의 AUTO_INCREMENT `admin_settings`
--
ALTER TABLE `admin_settings`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 테이블의 AUTO_INCREMENT `advertisings`
--
ALTER TABLE `advertisings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 테이블의 AUTO_INCREMENT `ad_click_impressions`
--
ALTER TABLE `ad_click_impressions`
...
--
-- 테이블의 AUTO_INCREMENT `conversations`
--
ALTER TABLE `conversations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `jobs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=235647;

--
-- 테이블의 AUTO_INCREMENT `languages`
--
ALTER TABLE `languages`
...
--
-- 테이블의 AUTO_INCREMENT `live_comments`
--
ALTER TABLE `live_comments`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 테이블의 AUTO_INCREMENT `live_likes`
--
ALTER TABLE `live_likes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `live_online_users`
--
ALTER TABLE `live_online_users`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 테이블의 AUTO_INCREMENT `live_streamings`
--
ALTER TABLE `live_streamings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 테이블의 AUTO_INCREMENT `live_streaming_private_requests`
--
ALTER TABLE `live_streaming_private_requests`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `login_sessions`
--
ALTER TABLE `login_sessions`
...
--
-- 테이블의 AUTO_INCREMENT `media_messages`
--
ALTER TABLE `media_messages`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `media_products`
--
ALTER TABLE `media_products`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 테이블의 AUTO_INCREMENT `media_stories`
--
ALTER TABLE `media_stories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `media_welcome_messages`
--
ALTER TABLE `media_welcome_messages`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- 테이블의 AUTO_INCREMENT `password_resets`
--
ALTER TABLE `password_resets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 테이블의 AUTO_INCREMENT `payment_gateways`
--
ALTER TABLE `payment_gateways`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- 테이블의 AUTO_INCREMENT `pay_per_views`
--
ALTER TABLE `pay_per_views`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `plans`
--
ALTER TABLE `plans`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- 테이블의 AUTO_INCREMENT `purchases`
--
ALTER TABLE `purchases`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 테이블의 AUTO_INCREMENT `referrals`
--
ALTER TABLE `referrals`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `referral_transactions`
--
ALTER TABLE `referral_transactions`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- 테이블의 AUTO_INCREMENT `reserved`
--
ALTER TABLE `reserved`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- 테이블의 AUTO_INCREMENT `restrictions`
--
ALTER TABLE `restrictions`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `shop_categories`
--
ALTER TABLE `shop_categories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 테이블의 AUTO_INCREMENT `states`
--
ALTER TABLE `states`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `stories`
--
ALTER TABLE `stories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `story_backgrounds`
--
ALTER TABLE `story_backgrounds`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- 테이블의 AUTO_INCREMENT `story_fonts`
--
ALTER TABLE `story_fonts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `story_views`
--
ALTER TABLE `story_views`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `stripe_state_tokens`
--
ALTER TABLE `stripe_state_tokens`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- 테이블의 AUTO_INCREMENT `subscription_deleteds`
--
ALTER TABLE `subscription_deleteds`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `subscription_items`
--
ALTER TABLE `subscription_items`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `tax_rates`
--
ALTER TABLE `tax_rates`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- 테이블의 AUTO_INCREMENT `two_factor_codes`
--
ALTER TABLE `two_factor_codes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `updates`
--
ALTER TABLE `updates`
...
--
-- 테이블의 AUTO_INCREMENT `user_devices`
--
ALTER TABLE `user_devices`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- 테이블의 AUTO_INCREMENT `verification_requests`
--
ALTER TABLE `verification_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `video_views`
--
ALTER TABLE `video_views`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- 테이블의 AUTO_INCREMENT `withdrawals`
--
ALTER TABLE `withdrawals`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
